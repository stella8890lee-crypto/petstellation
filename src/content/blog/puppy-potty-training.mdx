...
### Gradually Reduce Pad Coverage

- Days 1 to 3: Full pad coverage
- Days 4 to 7: Reduce coverage slightly
- Week 2: Keep one main pad area
- Week 3 and beyond: Transition outdoors gradually
...
For example, a 3-month-old puppy can hold it for about 4 hours.
